                        ...
                        <form onSubmit={handleEmailChange} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        {showEmailConfirmPassword ? <FiEyeOff size={20} /> : <FiEye size={20} />}
                                    </button>
                                </div>
                            </div>

                            <button type="submit" className="w-full rounded-md bg-red-600 px-4 py-3 text-lg font-semibold text-white duration-300 hover:bg-red-700">
