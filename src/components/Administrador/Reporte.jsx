                    ...
                    <div className="mx-auto w-full max-w-4xl rounded-lg bg-white p-6 shadow-lg">
                        <div className="mb-6 flex items-start justify-between">
                            <h2 className="text-2xl font-bold text-red-600">
                                Reporte de Accidente en {direccionAccidente}
                            </h2>
                            <div className="flex gap-2">
                                {report.isSubmitted ? (
                                    <>
                                        <button 
                                            onClick={handleEdit} 
                                            className="flex items-center gap-2 rounded bg-blue-500 px-4 py-2 text-white transition-colors hover:bg-blue-600"
                                        >
                                            <FileEdit size={20} />
                            ...
                            <div className="rounded-lg bg-gray-50 p-4">
                                ...
                                {isEditing || !report.isSubmitted ? (
                                    ...
                                    <p className="whitespace-pre-wrap text-gray-700">
                                        {report.descripcion || 'No hay descripción disponible'}
                                    </p>
                                )}
                            </div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {isEditing || !report.isSubmitted ? (
                                                <input 
                                                    type="date" 
                                                    value={report.fecha} 
                                                    onChange={(e) => setReport({...report, fecha: e.target.value})} 
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {isEditing || !report.isSubmitted ? (
                                                <input 
                                                    type="time" 
                                                    value={report.hora} 
                                                    onChange={(e) => setReport({...report, hora: e.target.value})} 
                                                    className="rounded border p-2" 
                                                />
                                            ) : (
