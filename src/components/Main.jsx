    ...
    return (
        <div className="flex w-full flex-wrap bg-neutral-200">
            <div className="w-full lg:w-1/2">
                ...
                <p className="ml-10 mt-10 text-lg lg:text-xl">Estamos aquí para ayudarte en los momentos más críticos. </p>
                <p className="ml-10 mt-10 text-lg lg:text-xl">Nuestro equipo de profesionales está listo para responder a tu llamada.</p>
