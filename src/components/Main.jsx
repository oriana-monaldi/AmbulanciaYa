...
return (
    <div className="flex w-full bg-neutral-200">
        <div className="w-1/2">
            <h1 className="text-3xl ml-10 mt-20 text-red-600">
                <strong>Atencion Medica de emergencia las 24 horas</strong>
            </h1>
            <p className="text-base ml-10 mt-8">
            ...
            <div className="flex">
                <svg
                    ...
                    className="icon icon-tabler icon-tabler-clock-shield w-10 h-8 ml-10 mb-3 mt-7"
                    width="44"
                    height="44"
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
            ...
            <div className="flex">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-10 h-8 ml-10 mb-5 mt-4"
                    width="44"
                    height="44"
                    viewBox="0 0 24 24"
                    fill="none"
        ...
        <div className="flex w-2/4	pl-40">
            <div className="bg-white">
                <h2 className="text-xl text-center mt-20 text-red-500">
