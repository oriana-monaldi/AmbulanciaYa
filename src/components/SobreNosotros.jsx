...
function SobreNosotros() {
    return (
        <div className='bg-neutral-200 flex flex-col items-center justify-center'>
            <h1 className='text-3xl text-center'><strong>Sobre Nosotros</strong></h1>
            <h2 className='text-2xl text-center mt-20'><strong>Nuestra Misión</strong></h2>
            ...
            <h2 className='text-2xl text-center mt-20'><strong>Nuestro Impacto</strong></h2>
